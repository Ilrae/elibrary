...
namespace WebApplication1
{
    public partial class usersignup : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Write("<script>alert('Already ID');</script>");
            }
            else
            {
                signUpNewMember();
        ...
        void signUpNewMember()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO member_master_table" +
                    "(full_name,dob,contact_no,email,state," +
                    "city,pincode,full_address,member_id,password,account_status) values(" +
                    "@full_name,@dob,@contact_no,@email,@stats,@city,@pincode,@full_address," +
                ...
                cmd.Parameters.AddWithValue("@stats", DropDownListState.SelectedItem.Value);
